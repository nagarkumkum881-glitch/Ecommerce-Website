    ...
    <Link to={`/products/${id}`} className={theme == "light" ? light : dark}>
      ...
      <div className="w-full">
        ...
        <div className="text-xs text-amber-400  pt-0.5 flex items-center  ">
         ...
         <div 
         className="flex gap-2 mt-1 justify-center  ">
                <button className={theme == "light" ?"bg-black text-white px-3 py-1.5 rounded-lg hover:bg-gray-800 transition ":"bg-black text-white px-6 py-1.5 rounded-lg hover:bg-gray-300 transition"}>
                  Add to Cart
                </button>
        </div>
      </div>
