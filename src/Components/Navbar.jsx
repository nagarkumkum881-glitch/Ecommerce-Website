...
//   return (
//     <div
//     className="h-12 w-screen border-2 border-blue-300 bg-blue-300 flex items-center justify-around">
//       < Link 
//       to="/"
//       className="text-2xl text-white font-extrabold">Shopsy</Link>
  ...
  return (
    <div className={theme == "light" ? light : dark}>
      ...
      <div className="flex justify-between items-center w-1/8">
        ...
        <Link to={"/Wishlist"} className="text-xl text-white ">Wishlist</Link>
        <Link to={"/Cart"} className="text-xl text-white ">Cart</Link>
      </div>
    </div>
  );
};
